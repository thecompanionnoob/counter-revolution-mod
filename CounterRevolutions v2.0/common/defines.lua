...
country = {
	...
	GOLD_TO_WORKER_PAY_RATE = 1.25, -- Multiplier for how much money gold pays to pops
...
diplomacy = {
	...
	WAR_FAILED_GOAL_MILITANCY = 4,
	WAR_FAILED_GOAL_PRESTIGE_BASE = -30,
	...
	OTHER_CONTINENT_BONUS_INFLUENCE_PERCENT = -0.40, -- Bonus to neighbouring countries when influencing
